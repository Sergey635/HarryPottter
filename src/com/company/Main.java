...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        harryPotter = harryPotter.replaceAll("\\.","");     // точка вписується тільки через "\\."
        String [] words = harryPotter.split(" ");                  //String[] масив стрингов, вордс = масив слов
        for (int i = 0; i <50 ; i++) {
...
// ДЗ. знайти знаки, які ще треба видалити